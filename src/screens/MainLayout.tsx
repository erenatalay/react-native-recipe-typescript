...
const MainLayout = ({drawerAnimationStyle, navigation}: any) => {
  ...
  React.useEffect(() => {
    ...
    if (selectedTab == constants.screens.add) {
      flatListRef?.current?.scrollToIndex({
        index: 4,
      });
    }
            ...
            return (
              <View
                ...
                {item.label == constants.screens.home && (
                  <Home navigation={navigation} scrollAnim={scrollAnim} />
                )}
                {item.label == constants.screens.search && (
                  <Search navigation={navigation} scrollAnim={scrollAnim} />
                )}
                {item.label == constants.screens.add && (
                  <Add navigation={navigation} scrollAnim={scrollAnim} />
                )}
                {item.label == constants.screens.bookmark && (
                  <Bookmark navigation={navigation} scrollAnim={scrollAnim} />
                )}
      ...
      <View
        ...
        <Animateds.View
          ...
          <TabButton
            ...
            onPress={() =>
              dispatch(setSelectedTab(constants.screens.search) as any)
            }
          />
          <TabButton
            label={constants.screens.add}
            icon={icons.add}
            isFocused={selectedTab == constants.screens.add}
            onPress={() =>
              dispatch(setSelectedTab(constants.screens.add) as any)
            }
          />
          ...
          <TabButton
            ...
            onPress={() =>
              dispatch(setSelectedTab(constants.screens.bookmark) as any)
            }
          />
          ...
          <TabButton
            ...
            onPress={() =>
              dispatch(setSelectedTab(constants.screens.settings) as any)
            }
          />
        </Animateds.View>
      </View>
